    ...
    <div class="page">
        ...
        <section class="section swiper-container swiper-slider swiper-slider-2 swiper-slider-3" data-loop="true"
            ...
            <div class="swiper-wrapper text-sm-left">
                            ...
                            <div class="row">
                                <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
                                    <h1 class="oh swiper-title"><span class="d-inline-block"
                                            data-caption-animate="slideInUp" data-caption-delay="0">Perfects
                                            pizza</span></h1>
                                    <p class="big swiper-text" data-caption-animate="fadeInLeft"
                                        data-caption-delay="300">Experience the taste of a perfect pizza at PizzaHouse,
                ...
                <div class="swiper-slide context-dark"
                    data-slide-bg="{{ asset('admin/ecommerce/images/slide-2-1920x753.jpg') }}">
                    <div class="swiper-slide-caption section-md">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-8 col-lg-7 offset-lg-1 offset-xxl-0">
                                    ...
                                    <p class="big swiper-text" data-caption-animate="fadeInRight"
                                        data-caption-delay="300">We use only the best ingredients to make one-of-a-kind
                                        pizzas for our customers.</p>
                ...
                <div class="row row-md row-30">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInDown">
                                <div class="services-terri-figure"><img
                                        src="{{ asset('admin/ecommerce/images/menu-2-370x278.jpg') }}" alt=""
                                        width="370" height="278" />
                                </div>
                                <div class="services-terri-caption"><span
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInUp">
                                <div class="services-terri-figure"><img
                                        src="{{ asset('admin/ecommerce/images/menu-3-370x278.jpg') }}" alt=""
                                        width="370" height="278" />
                                </div>
                                <div class="services-terri-caption"><span
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInDown">
                                <div class="services-terri-figure"><img
                                        src="{{ asset('admin/ecommerce/images/menu-4-370x278.jpg') }}" alt=""
                                        width="370" height="278" />
                                </div>
                                <div class="services-terri-caption"><span
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInUp">
                                <div class="services-terri-figure"><img
                                        src="{{ asset('admin/ecommerce/images/menu-5-370x278.jpg') }}" alt=""
                                        width="370" height="278" />
                                </div>
                                <div class="services-terri-caption"><span
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInDown">
                                <div class="services-terri-figure"><img
                                        src="{{ asset('admin/ecommerce/images/menu-6-370x278.jpg') }}" alt=""
                                        width="370" height="278" />
                                </div>
                                <div class="services-terri-caption"><span
                ...
                <div class="row row-lg row-30">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        ...
                        <article class="product wow fadeInLeft" data-wow-delay=".1s">
                            <div class="product-figure"><img
                                    src="{{ asset('admin/ecommerce/images/product-2-161x162.png') }}" alt=""
                                    width="161" height="162" />
                            </div>
                            <div class="product-rating"><span class="mdi mdi-star"></span><span
                                    class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        ...
                        <article class="product wow fadeInLeft" data-wow-delay=".05s">
                            <div class="product-figure"><img
                                    src="{{ asset('admin/ecommerce/images/product-3-161x162.png') }}" alt=""
                                    width="161" height="162" />
                            </div>
                            <div class="product-rating"><span class="mdi mdi-star"></span><span
                                    class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        ...
                        <article class="product wow fadeInLeft">
                            <div class="product-figure"><img
                                    src="{{ asset('admin/ecommerce/images/product-4-161x162.png') }}" alt=""
                                    width="161" height="162" />
                            </div>
                            <div class="product-rating"><span class="mdi mdi-star"></span><span
                                    class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span
                ...
                <div class="owl-carousel owl-style-12" data-items="1" data-sm-items="2" data-lg-items="3"
                    ...
                    <article class="quote-tara">
                        <div class="quote-tara-caption">
                            ...
                            <div class="quote-tara-figure"><img
                                    src="{{ asset('admin/ecommerce/images/user-6-115x115.jpg') }}" alt=""
                    ...
                    <article class="quote-tara">
                        <div class="quote-tara-caption">
                            ...
                            <div class="quote-tara-figure"><img
                                    src="{{ asset('admin/ecommerce/images/user-8-115x115.jpg') }}" alt=""
                                    width="115" height="115" />
                            </div>
                        </div>
                    ...
                    <article class="quote-tara">
                        <div class="quote-tara-caption">
                            ...
                            <div class="quote-tara-figure"><img
                                    src="{{ asset('admin/ecommerce/images/user-7-115x115.jpg') }}" alt=""
                                    width="115" height="115" />
                            </div>
                        </div>
        ...
        <section class="section section-sm bg-default">
            <div class="container">
                <div class="owl-carousel owl-style-11 dots-style-2" data-items="1" data-sm-items="1"
                    data-lg-items="2" data-xl-items="4" data-margin="30" data-dots="true" data-mouse-drag="true"
                    data-rtl="true">
