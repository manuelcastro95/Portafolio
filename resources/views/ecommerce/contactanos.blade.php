...
@section('titulo-miga', 'Contactanos')
...
@section('pagina_actual')
    @php $seleccionado = 'contacto'; @endphp
@endsection
                        ...
                        <div class="row row-20 gutters-20">
                            ...
                            <div class="col-12">
                                <div class="form-wrap">
                                    ...
                                    <textarea class="form-input textarea-lg" id="contact-message-5" name="message" data-constraints=""></textarea>
                                </div>
                            </div>
                        </div>
